...
type ToastActionType =
  | { type: "ADD_TOAST"; toast: ToastPropsWithId }
  | { type: "UPDATE_TOAST"; toast: Partial<ToastPropsWithId> }
...
type ToastInput = Omit<ToastPropsWithId, "id"> & {
  title?: React.ReactNode
  description?: React.ReactNode
  action?: ToastActionElement
}
...
function toast({ ...props }: ToastInput) {
  ...
  const update = (props: ToastPropsWithId) =>
